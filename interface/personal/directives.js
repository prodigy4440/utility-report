...
// Handle views access restriction
MetronicApp.directive("adminAccess", ["$compile", "$rootScope", function ($compile, $rootScope) {
    return {
      restrict: 'A',
      priority: 1001,
      compile: function (elem) {
        elem.removeAttr("admin-access");
        var userInfo = $rootScope.userInfo;
        elem.attr("ng-if", userInfo && userInfo.role === "ADMIN");
        var fn = $compile(elem);
